        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Coming soon - Game discovery powered by IGDB
            </p>
          </div>

          <Card className="p-12 text-center max-w-xl mx-auto">
            <Gamepad2 className="w-16 h-16 mx-auto mb-4 text-muted-foreground" />
            <h3 className="text-xl font-medium mb-2">Games Coming Soon</h3>
            <p className="text-muted-foreground mb-6">
              We&apos;re working on integrating IGDB for game discovery. Stay tuned!
            </p>
